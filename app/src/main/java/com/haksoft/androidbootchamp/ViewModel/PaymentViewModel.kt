package com.haksoft.androidbootchamp.ViewModel
...
import com.haksoft.androidbootchamp.Api.ApiRepository.ApiRepository
import com.haksoft.androidbootchamp.Api.Model.ConversionRates
import com.haksoft.androidbootchamp.Api.Model.Currency
import com.haksoft.androidbootchamp.Database.Payment
import com.haksoft.androidbootchamp.Database.PaymentDataBase
import com.haksoft.androidbootchamp.Database.PaymentRepository
...
class PaymentViewModel(application : Application):AndroidViewModel(application) {
    ...
    val preferences = application.getSharedPreferences("com.haksoft.androidbootchamp", Context.MODE_PRIVATE)
        ...
        viewModelScope.launch {
            repository.getConverted(base).enqueue(object : Callback<Currency> {
                ...
                override fun onFailure(call: Call<Currency>, t: Throwable) {
                    ...
                    val usd = preferences?.getFloat("USDToTRY", 0.131F)?.toDouble()!!
                    val gbp = preferences?.getFloat("GBPToTRY", 0.08621F)?.toDouble()!!
                    val eur = preferences?.getFloat("EURToTRY", 0.1039F)?.toDouble()!!
